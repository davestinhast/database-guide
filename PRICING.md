...
| **Supabase** | PostgreSQL | 500 MB | 50K MAU, 5 GB egress | [AVISO] Pausa tras 1 semana sin uso |  Muy completo |
...
| **Firebase Firestore** | NoSQL doc | 1 GB | 50K reads/día, 20K writes/día |  Nunca | [AVISO] Los límites diarios son bajos |
| **Railway** | Cualquiera | Usage-based | $5 crédito one-time (Hobby trial) | [AVISO] Crédito se agota | [AVISO] No es realmente free |
...
[AVISO] Compute se suspende al agotar límite del mes
```
...
[AVISO] Proyectos PAUSAN tras 1 semana de inactividad
[AVISO] 50 MB máximo por upload
```
...
[AVISO] Nadie paga list price — descuentos enterprise: 40–70%
```
